...
const messageEmbed = new EmbedBuilder()
  ...
  .setDescription(
    ...
    "<:zeusaa:1433927475976474624> *Realiza tu compra solo con un seller*")
...
module.exports = {
  ...
  async execute(client) {
    ...
    const sendGeneralMessage = async () => {
      ...
      // ✅ Pasamos los botones como array al utility
      await sendEmbed(client, channels.AUTO_MESSAGE, messageEmbed, [generalButtons]);
    ...
    const sendRandomProductMessage = async () => {
      ...
      // ✅ Botones construidos aquí dentro
      const promoRow = new ActionRowBuilder().addComponents(
        ...
        new ButtonBuilder()
          .setLabel('Instagram')
          .setURL('https://www.instagram.com/novendoche4ts.pe')
          .setStyle(ButtonStyle.Link)
      );
